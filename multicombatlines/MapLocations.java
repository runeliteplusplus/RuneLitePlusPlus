...
public class MapLocations
{
    ...
    private static void defineWildernessLevelLines()
    {
        ...
        Map<Integer,Integer> levelTilesMap = new HashMap<>();
        levelTilesMap.put(1, 3);
        levelTilesMap.put(2, 8);
        levelTilesMap.put(3, 8);
        levelTilesMap.put(4, 8);
        levelTilesMap.put(5, 8);
        levelTilesMap.put(6, 8);
        levelTilesMap.put(7, 8);
        levelTilesMap.put(8, 8);
        levelTilesMap.put(9, 8);
        levelTilesMap.put(10, 8);
        levelTilesMap.put(11, 8);
        levelTilesMap.put(12, 8);
        levelTilesMap.put(13, 8);
        levelTilesMap.put(14, 8);
        levelTilesMap.put(15, 8);
        levelTilesMap.put(16, 8);
        levelTilesMap.put(17, 8);
        levelTilesMap.put(18, 8);
        levelTilesMap.put(19, 8);
        levelTilesMap.put(20, 8);
        levelTilesMap.put(21, 8);
        levelTilesMap.put(22, 8);
        levelTilesMap.put(23, 8);
        levelTilesMap.put(24, 8);
        levelTilesMap.put(25, 8);
        levelTilesMap.put(26, 8);
        levelTilesMap.put(27, 8);
        levelTilesMap.put(28, 8);
        levelTilesMap.put(29, 8);
        levelTilesMap.put(30, 8);
        levelTilesMap.put(31, 8);
        levelTilesMap.put(32, 8);
        levelTilesMap.put(33, 8);
        levelTilesMap.put(34, 8);
        levelTilesMap.put(35, 8);
        levelTilesMap.put(36, 8);
        levelTilesMap.put(37, 8);
        levelTilesMap.put(38, 8);
        levelTilesMap.put(39, 8);
        levelTilesMap.put(40, 8);
        levelTilesMap.put(41, 8);
        levelTilesMap.put(42, 8);
        levelTilesMap.put(43, 8);
        levelTilesMap.put(44, 8);
        levelTilesMap.put(45, 8);
        levelTilesMap.put(46, 8);
        levelTilesMap.put(47, 8);
        levelTilesMap.put(48, 8);
        levelTilesMap.put(49, 8);
        levelTilesMap.put(50, 8);
        levelTilesMap.put(51, 8);
        levelTilesMap.put(52, 8);
        levelTilesMap.put(53, 8);
        levelTilesMap.put(54, 8);
        levelTilesMap.put(55, 8);
        levelTilesMap.put(56, 8);

        // define wilderness level lines above ground
        int accumulatedY = 0;
        for (int level = 1; level <= Collections.max(levelTilesMap.keySet()); level++)
        {
            Integer levelTiles = levelTilesMap.get(level);
            if (levelTiles != null) {
                // only draw every 2 levels, otherwise lines on two adjacent levels will collide
                // and it doesn't end up showing up for some reason
                if (level % 2 != 0) {
